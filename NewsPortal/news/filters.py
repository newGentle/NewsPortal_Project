...
class PostFilter(FilterSet):
    ...
    post_type = django_filters.ChoiceFilter(field_name='post_type', choices=Post.CHOICE, label='Тип', empty_label='Все', widget=forms.Select(attrs={'class': 'me-2 mb-2 form-control'}))
